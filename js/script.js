...
$('#customers-testimonials-1').owlCarousel({
  interval: false,
  nav: true,
...
$('#customers-testimonials-4').owlCarousel({
  /* rtl: true, */
  nav: true,
  navText: ["<div class='nav-button owl-prev'>‹</div>", "<div class='nav-button owl-next'>›</div>"],
  items: 3,
...
$('#customers-testimonials-5').owlCarousel({
  interval: false,
  nav: true,
  navText: ["<div class='nav-button owl-prev'>‹</div>", "<div class='nav-button owl-next'>›</div>"],
  items: 3,
...
$('#customers-testimonials-6').owlCarousel({
  /* rtl: true, */
  nav: true,
  navText: ["<div class='nav-button owl-prev'>‹</div>", "<div class='nav-button owl-next'>›</div>"],
  items: 3,
...
$('#customers-testimonials-7').owlCarousel({
  /* rtl: true, */
  nav: true,
  navText: ["<div class='nav-button owl-prev'>‹</div>", "<div class='nav-button owl-next'>›</div>"],
  items: 3,
...
popupWhatsApp = () => {
  ...
  sendBtn.addEventListener("click", () => {
    ...
    window.open('https://wa.me/573127704516?text=' + relmsg, '_blank');
...
sendOrderBtn.addEventListener("click", () => {
  ...
  if (name == null || tel == null || dir == null 
   ...
   window.open('https://wa.me/573127704516?text='+ relmsg + "%0a"
  + "---------------------------------" + "%0a"
  + "       DATOS DEL PEDIDO          " + "%0a"
  + "---------------------------------" + "%0a"
  + carritoEnTexto + "%0a"
